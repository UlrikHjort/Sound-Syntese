...
package Sawtooth_Wave is
   ----------------------------------------------------------------------
   --
   --
   --
   ----------------------------------------------------------------------
   procedure Generate(Frequency : in Float; Amplitude : in Float; Sampling_Rate : in Unsigned_32; Wave_Data_Buffer : in out Dynamic_Wave_Data_Buffer_Access);
end Sawtooth_Wave;
